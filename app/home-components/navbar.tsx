  ...
  return (
    <header className="w-full min-h-16 sticky top-0 bg-[#ffd2aeca] z-[400]">
      <div className="w-full m-auto py-5 px-4 grid place-items-center [grid-template-columns:repeat(auto-fit,minmax(500px,1fr))] gap-[2.5em] scale-[0.75]">
        ...
        <div className="min-h-16 w-full h-full">
          <ul className="flex justify-end items-center gap-[1vw] w-full h-full">
            {["Home", "About", "Contact"].map((label, index) => (
              <li key={label} className="relative group">
                ...
                <Link
                  ...
                  className="text-xl px-[3vw] py-2 text-gray-900 font-semibold hover:bg-orange-100 group-hover:text-[#d85700]"
                >
                  {label}
                </Link>
              </li>
